    ...
    <div className="flex flex-col gap-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
          Select a destination to view, edit, and manage its associated Payment Mode.
        </p>
      </div>
        ...
        <div className="mt-6">
            {selectedPlaceId ? (
                <textarea
                    ...
                    placeholder="Enter the payment mode for this destination..."
                    disabled={!isEditing}
                />
            ) : (
              <div className="text-center py-20 flex flex-col items-center justify-center">
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400">
                    {isListLoading ? "Loading..." : "Please select a destination to manage its payment mode."}
                  </p>
              </div>
            )}
        </div>
